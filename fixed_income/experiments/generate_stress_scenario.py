...
data_folder = pathlib.Path(
    r"/Users/samrullo/programming/pyprojects/fi_djrest_project/data"
)
...
if __name__ == "__main__":
    ...
    generate_scenarios(
        adate, curve_name, scenario_id=0, periods_with_shocks=period_with_shocks
    )
